...
class DifferentLetters
{
    static void Main()
    {
        ...
        string inputText = @"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. 
            ...
            metus vitae pharetra auctor, sem massa mattis sem, at interdum magna augue eget diam. Vestibulum ante ipsum primis in 
            faucibus orci luctus et ultrices posuere cubilia Curae; Morbi lacinia molestie dui. Praesent blandit dolor. Sed non quam. 
            ...
            ultrices sit amet, augue. Proin sodales libero eget ante. Nulla quam. Aenean laoreet.".ToLower();
        ...
        foreach (var ch in inputText)
        {
            if (char.IsLetter(ch))
            {
                ...
                {
                    countLetters.Add(ch, 1);
                }
            }
        }
        foreach (var letters in countLetters)
        {
            Console.WriteLine("{0} is found {1} times.", letters.Key, letters.Value);
        }
    }
}
